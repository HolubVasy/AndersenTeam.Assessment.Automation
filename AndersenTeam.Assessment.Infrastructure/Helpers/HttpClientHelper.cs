...
public static class HttpClientHelper
{
    public static async Task<HttpResponseMessage?> SendRequest<T>(T data, string token)
    {
        ...
        using HttpClient client = CreateHttpClient(baseUri, token);
    ...
    public static async Task<IList<TModelDto>?> SendRequest<TModelDto>(string token, 
        string requestUri,
        params string[] parameters)
    {
        using HttpClient client = CreateHttpClient(UriHelper.BaseUri, token);
        ...
        {
            return (await response.Content.ReadFromJsonAsync(typeof(IList<TModelDto>))) 
                as IList<TModelDto>;
        }
    ...
    private static HttpClient CreateHttpClient(string baseUri, string token)
    {
